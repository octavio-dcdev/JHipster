...
import com.theironyard.novauc.JHipsterApp;
...
public class ToDoResourceIntTest {
    ...
    private static final String DEFAULT_NAME_COLLEGE = "AAAAAAAAAA";
    private static final String UPDATED_NAME_COLLEGE = "BBBBBBBBBB";

    private static final String DEFAULT_PURSUE_MBA = "AAAAAAAAAA";
    private static final String UPDATED_PURSUE_MBA = "BBBBBBBBBB";
    ...
    public static ToDo createEntity(EntityManager em) {
        ToDo toDo = new ToDo()
            ...
            .nameCollege(DEFAULT_NAME_COLLEGE)
            .pursueMBA(DEFAULT_PURSUE_MBA);
        return toDo;
    }
    ...
    public void createToDo() throws Exception {
        ...
        assertThat(testToDo.getFirstName()).isEqualTo(DEFAULT_FIRST_NAME);
        assertThat(testToDo.getNameCollege()).isEqualTo(DEFAULT_NAME_COLLEGE);
        assertThat(testToDo.getPursueMBA()).isEqualTo(DEFAULT_PURSUE_MBA);
    }
    ...
    public void getAllToDos() throws Exception {
        ...
        restToDoMockMvc.perform(get("/api/to-dos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nameCollege").value(hasItem(DEFAULT_NAME_COLLEGE.toString())))
            .andExpect(jsonPath("$.[*].pursueMBA").value(hasItem(DEFAULT_PURSUE_MBA.toString())));
    }
    ...
    public void getToDo() throws Exception {
        ...
        restToDoMockMvc.perform(get("/api/to-dos/{id}", toDo.getId()))
            ...
            .andExpect(jsonPath("$.nameCollege").value(DEFAULT_NAME_COLLEGE.toString()))
            .andExpect(jsonPath("$.pursueMBA").value(DEFAULT_PURSUE_MBA.toString()));
    }
    ...
    public void updateToDo() throws Exception {
        ...
        updatedToDo
            ...
            .nameCollege(UPDATED_NAME_COLLEGE)
            .pursueMBA(UPDATED_PURSUE_MBA);
        ...
        ToDo testToDo = toDoList.get(toDoList.size() - 1);
        assertThat(testToDo.getFirstName()).isEqualTo(UPDATED_FIRST_NAME);
        assertThat(testToDo.getNameCollege()).isEqualTo(UPDATED_NAME_COLLEGE);
        assertThat(testToDo.getPursueMBA()).isEqualTo(UPDATED_PURSUE_MBA);
    }
